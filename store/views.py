...
def restaurants(request):
    ...
    return render(request, 'store/restaurants.html', {'categories':categories})

def howtoorder(request):
    return render(request, 'store/howtoorder.html')  
...
class AddressView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            reg = Address(user=user, locality=locality, city=city, state=state, mobile=mobile)
            reg.save()
